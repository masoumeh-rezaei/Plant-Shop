            ...
            {slides.map((slide: Slide, idx: number) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div className="w-2/3 h-auto z-20 ">
                      <Image
                          src={slide.image}
                          alt={slide.title}
                          width={400}
                          height={400}
                          className="w-full h-auto object-cover rounded-[2rem] -mb-45"
                      />
                    </div>

                    {/* The new Glass Card Container with decorative borders */}
                    <div className="relative w-[80%] p-6 pt-48 pb-4
                      ...
                      <button
                          ...
                          className="absolute top-2/3 right-4 -translate-y-1/2 p-2 rounded-full  transition-colors z-30"
                      >
                        <ArrowRight className="dark:text-white text-gray-700 w-5 h-5" />
                      </button>

                      {/* Decorative lines and corners from the TransparentCard */}
