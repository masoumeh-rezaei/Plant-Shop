    ...
    return (
        <div className="w-full ">
            <DeeperTransparentCard>
                <div className="flex flex-col md:flex-row items-center gap-6 md:px-20 py-10">
                    ...
                    <div className="relative flex justify-center items-center w-full md:w-1/2 -mt-10 md:-mt-30 z-20">
                        <Image
                            ...
                            width={200}
                            height={200}
                            className="w-60 md:!w-80 h-auto object-cover rounded-xl items-center"
                        />
                    </div>

                    {/* ستون راست: محتوای محصول */}
                    <div className="w-full md:w-1/2 flex flex-col justify-center items-center h-full gap-4 dark:text-white text-black px-4 md:px-0">
                        <div className="flex flex-col gap-4 md:gap-6 text-center md:text-left">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-2">{title}</h3>
                            <div>
